...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        createThemeAndMeals("Monday - Breakfast", List.of(
        ...
        createThemeAndMeals("Tuesday - Tacos", List.of(
        ...
        createThemeAndMeals("Wednesday - Pasta", List.of(
        ...
        createThemeAndMeals("Thursday - Meat & Potatoes", List.of(
        ...
        createThemeAndMeals("Saturday - Pizza or Pasta", List.of(
        ...
        createThemeAndMeals("Sunday - BBQ Style", List.of(
    ...
    private void createThemeAndMeals(String themeName, List<Map<String, Object>> mealsData) {
        DayTheme theme = dayThemeRepository.findByName(themeName)
                .orElseGet(() -> dayThemeRepository.save(new DayTheme(themeName)));
